...
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
      var selectedKey = _this.props.children[index].key                           ///
                                                                                  ///
      _this.props.passUpActiveIndex(selectedKey)                                  ///  
                                                                                  ///
                                                                                  ///
      if (_this.props.selectedTabRowKeys.indexOf(selectedKey) == -1){             ///
        index = -1                                                                ///
      }                                                                           ///
/////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////
  ...
  _createClass(Tabs, [{
    ...
    value: function componentWillReceiveProps(newProps, nextContext) {
      ...
      if (newProps.selectedTabRowKeys.indexOf(this.props.children[0].key) == -1){
        newState.selectedIndex = -1
      } 
      else if (valueLink.value !== undefined) {
    ...
    value: function render() {
      ...
      // var container = _reactDom.findDOMNode(document.getElementById("content"))
